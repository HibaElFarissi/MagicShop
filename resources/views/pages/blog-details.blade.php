                ...
                <div class="col-lg-9">
                    <div class="single-page pr-30">
                        <div class="single-header style-2">
                            <h1 class="mb-30">Best smartwatch 2024: the top wearables you can buy today</h1>
                            <div class="single-header-meta">
                                <div class="entry-meta meta-1 font-xs mt-15 mb-15">
                                    <span class="post-by">By <a href="#">Jonh</a></span>
                                    <span class="post-on has-dot">9 April 2024</span>
                            ...
                            <div class="post-block-list post-module-1 post-module-5">
                                <ul>
                                    @forelse ($categories as $category)
                                                <li class="cat-item cat-item-2"><a href="/">{{ $category->name }}</a>100%</li>
                                            @empty
