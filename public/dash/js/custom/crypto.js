(function() {
	...
	var chart = new ApexCharts(document.querySelector("#market_graph"), options);
	chart.render();
    ...
    var options = {
        series: [
            { name: "Visits", 
                data: [10, 20, 10, 40, 25, 60, 35, 80, 45, 100, 55] 
            }
        ],
        chart: { 
            type: "area", 
    ...
    chart = new ApexCharts(
        document.querySelector("#visits_by_day"), 
        options
    );
    chart.render();
    ...
    chart = new ApexCharts(
        document.querySelector("#referral_join"), 
        options
    );
    chart.render();
